...
This page mirrors the root `ARCHITECTURE.md` for convenience within the docs site. The canonical source is maintained at the repository root.

> Note: Keep `CONTRIBUTING.md` and `CODE_OF_CONDUCT.md` in the repository root as per GitHub conventions.
